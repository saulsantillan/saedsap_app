package com.mercadolibre.saedsap_demo_app.config;

import static com.mercadolibre.saedsap_demo_app.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.saedsap_demo_app.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("saul santillan")
                .email("saul.santillan@mercadolibre.com.mx"));
